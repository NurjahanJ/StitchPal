...
class _ProjectTrackerScreenState extends State<ProjectTrackerScreen> with SingleTickerProviderStateMixin {
  ...
  // Build yarn recommendations section
  Widget _buildYarnRecommendationsSection() {
    if (_project.yarnSuggestions.isEmpty) {
      return const SizedBox.shrink(); // Return empty widget if no recommendations
    }
    ...
    return Column(
      ...
      children: [
        ...
        ListView.separated(
          ...
          itemCount: _project.yarnSuggestions.length,
          separatorBuilder: (context, index) => const SizedBox(height: 12),
          itemBuilder: (context, index) {
            return Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16.0),
              child: YarnSuggestionCard(suggestion: _project.yarnSuggestions[index]),
            );
          },
        ),
      ],
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Show yarn recommendations first for better visibility
                if (_project.yarnSuggestions.isNotEmpty) ...[
                  _buildYarnRecommendationsSection(),
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    color: StitchPalTheme.accentColor.withAlpha(
                      (StitchPalTheme.accentColor.a * 0.2).round(),
                    ),
                    borderRadius: BorderRadius.circular(12),
                  ),
                  child: Text(
                    ...
                    style: Theme.of(context).textTheme.bodySmall?.copyWith(
                      color: StitchPalTheme.textColor.withAlpha(
                        (StitchPalTheme.textColor.a * 0.7).round()
                      ),
                    ),
                  ),
                );
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: _getProgressColor(_project.progress).withAlpha(
                      (_getProgressColor(_project.progress).a * 0.2).round()
                    ),
                  ),
                  child: Center(
                    child: Text(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: StitchPalTheme.primaryColor.withAlpha(
                    (StitchPalTheme.primaryColor.a * 0.1).round(),
                  ),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(

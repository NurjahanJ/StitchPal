...
import 'package:stitchpal/services/pattern_assistant_service.dart';
import 'package:stitchpal/theme.dart';
import 'package:stitchpal/widgets/chat_bubble.dart';

class PatternAssistantModal extends StatefulWidget {
  final CrochetPattern pattern;

  const PatternAssistantModal({
    super.key,
    required this.pattern,
  });

  @override
  State<PatternAssistantModal> createState() => _PatternAssistantModalState();
}

class _PatternAssistantModalState extends State<PatternAssistantModal> {
  final TextEditingController _textController = TextEditingController();
  final ScrollController _scrollController = ScrollController();
  final PatternAssistantService _assistantService = PatternAssistantService();
  ...
  void _addWelcomeMessage() {
    _messages.add(
      ChatMessage(
        text: "Hi there! I'm your crochet pattern assistant. How can I help you with the '${widget.pattern.title}' pattern?",
  ...
  void _handleSubmit(String text) async {
    ...
    final response = await _assistantService.getPatternAssistance(
      userQuery: text,
